...
class OtherChartCombinedState extends CombinedActionState<OtherChartCombined> {
  ...
  BarData generateBarData() {
    List<BarEntry> entries1 = List<BarEntry>.empty();
    List<BarEntry> entries2 = List<BarEntry>.empty();
  ...
  CandleData generateCandleData() {
    ...
    List<CandleEntry> entries = List<CandleEntry>.empty();
  ...
  BubbleData generateBubbleData() {
    ...
    List<BubbleEntry> entries = List<BubbleEntry>.empty();
