...
class ScatterChart extends Chart {
  ...
  ScatterChart(ScatterData data,
      InitScatterChartPainterCallback initScatterChartPainterCallback,
      {Color backgroundColor = null,
      Color borderColor = null,
      double borderStrokeWidth = 1.0,
      bool keepPositionOnRotation = false,
      ...
      : backgroundColor = backgroundColor,
        ...
        super(data, (p) {
          if (p is ScatterChartPainter) {
            initScatterChartPainterCallback(p);
          }
        },
            backgroundColor: backgroundColor,
            borderColor: borderColor,
...
class ScatterChartState extends ChartState<ScatterChartPainter, ScatterChart> {
  @override
  void initialPainter() {
...
typedef InitScatterChartPainterCallback = void Function(
    ScatterChartPainter painter);
