      ...
      : super(
          ...
          (painter) {
            if (painter is HorizontalBarChartPainter) {
              initHorizontalBarChartPainterCallback(painter);
            }
          },
...
class HorizontalBarChartState
    extends ChartState<BarChartPainter, HorizontalBarChart> {
      ...
      if (painter.mDragYEnabled && painter.mDragXEnabled) {
        ...
        if (painter.mDragXEnabled) {
          ...
          if (_inverted()) {
            ...
            if (painter is HorizontalBarChart) {
              dx = -dx;
            } else {
              dy = -dy;
            }
...
typedef InitHorizontalBarChartPainterCallback = void Function(
    HorizontalBarChartPainter painter);
